...
class ExampleObject : GameObject(Rectangle(10, 0, 80, 96)) {
    private var texture: GameTexture? = null

    init {
        // Remember that tiles are 32x32 pixels in size
        hoverHitbox = Rectangle(10, 0, 80, 96) // 2 tiles high mouse hover hitbox
    ...
    override fun addDrawables(
        list: MutableList<LevelSortedDrawable>,
        tileList: OrderableDrawables,
        level: Level,
        tileX: Int,
        tileY: Int,
